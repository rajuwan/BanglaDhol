...
public class DynamicTwoWayBaseAdapter extends BaseAdapter {
	...
	public DynamicTwoWayBaseAdapter(Context context, String[] contentTitleArray,
			String[] contentImageArray) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			view = mInflater.inflate(R.layout.card_list_item, parent, false);
