...
public class DynamicViewAllAdapter extends BaseAdapter {
    ...
    private String[] contentTitleArray, contentArtistArray, contentAlbumArray,
            contentLengthArray, contentImageArray;

    public DynamicViewAllAdapter(Context context, String[] contentTitleArray, String[] contentArtistArray,
                                 String[] contentAlbumArray, String[] contentLengthArray, String[] contentImageArray) {

        this.context = context;
        this.contentTitleArray = contentTitleArray;
        this.contentArtistArray = contentArtistArray;
        this.contentAlbumArray = contentAlbumArray;
        this.contentLengthArray = contentLengthArray;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.text2.setText(contentArtistArray[position] + "-");
        holder.text3.setText(contentAlbumArray[position]);
        holder.text4.setText(contentLengthArray[position]);
