...
public class JSONParser {
	 ...
	 * httpEntity = httpResponse.getEntity(); inputStream =
	...
	/*
	 * public JSONObject getJSONHttpClient(String url) throws
	 * ClientProtocolException, IOException, JSONException { JSONObject
	 * jsonObject = null; try { openHttpClient(url);
	 * 
	 ...
	 * json = sb.toString();
	 * 
	 * Log.d("json", json); jsonObject = new JSONObject(json);
	 * 
	 * } finally { FileUtils.close(inputStream); FileUtils.close(reader); }
	 * return jsonObject; }
	 */

	// using HttpURLConnection for > Froyo
	public String getJSONHttpURLConnection(String urlString)
	...
	public JSONObject getJSONHttpURLConnection2(String urlString)
			throws IOException, JSONException {
